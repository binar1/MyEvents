...
<div class="row divbg">
	...
	<?php if ($organization->data()->verify) {
		echo "<img src='../images/verify.png' width='35px' height='35px' style='margin-left:20px;'>";
	} ?>	
	</div>
	<div class="col-sm-5 divname">
		<p style="margin-top: 80px;">
			<label>Address : <?php echo $organization->data()->address ?></label>
			<label>Phone Number : <?php echo $organization->data()->phone ?></label>
		</p>
	</div>

	<div class="btn-group btn-group-justified" style="width: 100%;">
  <a href=<?php echo "ProfileOrganization.php?profile=".$_GET['profile']; ?> class="btn btn-danger" style="width: 25%;" class="active">Events</a>
...
<div class="container">
	...
	<div class="row" style="background-color: white; width: 100%;height:400px;overflow:scroll;">
		<?php
           $events=new Event(null,null,$organization->data()->organization_id);
           if ($events->result()) {
	...
	<div style="background-color: white; width: 100%; padding: 10px;border:1px solid black;">
			...
			<div style="background-color: white;padding: 50px;"><!--Phone Number -->
				...
				<table class="table table-striped" style="background-color: #c4c4a1;">
					<tr><td> Number : <?php echo $organization->data()->phone; ?></td></tr>
