...
<div class="container-fluid" style="background-color:black;">
  ...
  <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3" >
                      <h6 class="text-uppercase mb-4 font-weight-bold" style="color:white;margin-bottom:20px;">Find Events</h6>
                      <p><a class="footer-links"  href="#!">Sulaimanyah</a></p>
                      <p><a class="footer-links"  href="#!">Hawler</a></p>
                      <p><a class="footer-links"  href="#!">New York</a></p>
                      <p><a class="footer-links" href="#!">London</a></p>
                      <p><a class="footer-links"  href="#!">All Cities</a></p>
                  </div>
...
<hr style="color:white;margin:0;padding:0;" > 
                      <div class="container-fluid" style="background-color:black;">
                      <h4 class=" mb-4 font-weight-bold" style="color:#888b92;margin-bottom:20px;margin-left:50%">
                      &copyMyEvents</h4>
